...
#### Audio Models (Special handling, automatically processed internally by RealmAI API)
...
RealmAI API adopts a dual billing mechanism of pre-consumption and post-consumption:
