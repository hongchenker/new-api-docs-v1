...
This document provides a graphical tutorial for deploying RealmAI API using the 1Panel panel.
...
## Step 2: Install RealmAI API

### Search for Applications

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the RealmAI API application under the [AI] category, and install it.
</Callout>
...
<Callout type="info" title="Install Application">
  Configure RealmAI API application parameters on the installation page:
</Callout>

- **Name**: The name of the RealmAI API application to be created
- **Version**: Select the version of RealmAI API
- **Port**: The service port for the RealmAI API application
...
<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the RealmAI API application status to change to Started.
</Callout>
...
1. In the 1Panel application list, click the **Parameters** button for the RealmAI API application
...
## Step 4: Access RealmAI API

<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the RealmAI API WebUI page
...
2. Find the RealmAI API application, click the **Upgrade** button
