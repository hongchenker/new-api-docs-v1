...
This document provides methods and best practices for updating the RealmAI API system to ensure a smooth upgrade to the latest version.
...
If you have deployed RealmAI API using a single Docker container, you can update by following these steps:
...
2.  Find the RealmAI API application and click the **Upgrade** button
...
2.  Find the RealmAI API container, click **More** -> **Recreate**
...
If you have deployed RealmAI API by compiling from source code, the update steps are as follows:
