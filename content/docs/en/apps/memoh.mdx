...
description: Memoh integration guide — Connect the self-hosted containerized AI agent platform to RealmAI API, creating AI bots with long-term memory for Telegram, Discord, Lark, QQ, WeChat, and more.
---
...
After registering and logging in to NewAPI, click "Console" in the top navigation bar, then click "Token Management", and click the "Add Token" button to create a RealmAI API Key. Select the appropriate permissions and click "Create".
