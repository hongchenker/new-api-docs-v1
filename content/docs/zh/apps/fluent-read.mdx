...
description: FluentRead 教程 — 开源浏览器翻译插件，支持 20+ 翻译引擎与 AI 大模型翻译。对接 RealmAI API 实现沉浸式双语阅读体验。
---
...
### 从 RealmAI API 控制台导入配置（推荐）

当浏览器安装了流畅阅读插件后，打开 RealmAI API 控制台->令牌管理页面会弹出添加流畅阅读的提示
